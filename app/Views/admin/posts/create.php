            ...
            <form method="post" action="<?= base_url('/admin/posts/store'); ?>" enctype="multipart/form-data">
                <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control <?= get_validation_class('category_id', $errors ?? []); ?>">
                                    ...
                                    <?php foreach ($categories as $category) : ?>
                                        <option value="<?= $category['id']; ?>" <?= selected('form_data', 'category_id', $category['id']); ?>><?= $category['title']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= get_validation_class('excerpt', $errors ?? []); ?>" name="excerpt" id="excerpt" placeholder="Enter your excerpt" value="<?= oldfFromSession('form_data', 'excerpt'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="content" name="content" class="form-control summernote <?= get_validation_class('content', $errors ?? []); ?>" rows="3" placeholder="Content"><?= oldfFromSession('form_data', 'content'); ?></textarea>
